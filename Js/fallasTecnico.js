...
function inicio ()
{
	...
	$('.linkAtrasObservacion').on("click",function()
		{
			actionBotones('menuConsultarFallas','menuIngresarObservaciones');
			consultarFallasIndi(fallaSeleccionada);
...
function consultarFallasIndi(id2)
{
...
function mostrarObservaciones()
{
	...
	actionBotones("menuIngresarObservaciones","menuConsultarFallas");
