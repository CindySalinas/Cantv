...
$sql = "SELECT S.Id_Sala,S.Id_Central,S.Nombre,S.Piso,S.Descipcion,C.Nombre,C.Direccion,C.Latitud,C.Longitud FROM salas S INNER JOIN centrales C ON S.Id_Central = C.Id_Central ORDER BY S.Id_Sala asc";
